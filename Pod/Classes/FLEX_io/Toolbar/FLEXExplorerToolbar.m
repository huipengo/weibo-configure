...
@property (nonatomic, strong, readwrite) FLEXToolbarItem *customItem;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *customIcon = [FLEXResources globeIcon];
        self.customItem = [FLEXToolbarItem toolbarItemWithTitle:@"service" image:customIcon];
        ...
        self.toolbarItems = @[_globalsItem, _hierarchyItem, _selectItem, _moveItem, _customItem, _closeItem];
    }
