...
- (void)setupToolbarActions
{
    ...
    [self.explorerToolbar.customItem addTarget:self action:@selector(customButtonTapped:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)customButtonTapped:(FLEXToolbarItem *)sender {
    [self.delegate explorerViewControllerCustomAction:self];
}
